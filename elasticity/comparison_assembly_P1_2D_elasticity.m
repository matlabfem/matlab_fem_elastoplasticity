...
% add_paths;
addpath(genpath('3rd_party_elasticity_codes_for_testing'),'elasticity_2D');
...
for level=0:levels    
    ...
    [HatP,DHatP1,DHatP2] = local_basis_volume('P1', Xi); % local basis functions and their derivatives for volume  integrals
    ...
    K=elastic_stiffness_matrix(elements',coordinates',shear,bulk,DHatP1,DHatP2,WF); 
    assembly_time=toc; 
...
rmpath(genpath('3rd_party_elasticity_codes_for_testing'),'elasticity_2D');
