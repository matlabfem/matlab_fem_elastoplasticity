%
function f_V=vector_volume(ELEM,COORD,f_V_int,HatP,DHatP1,DHatP2,DHatP3,WF)
 
% ======================================================================
%
% Assembling of the vector of volume forces
%
%    output: f_V - vector of volume forces, size(f_V)=(3,n_n)
...
%      DHatP3- xi_3-derivatives of the basis functions at quadrature points
%              size(HatP)=size(DHatP1)=size(DHatP2)=size(DHatP3)=(n_p,n_q)
...
%   
  ...
  % extension of the input arrays HatP,DHatP1,DHatP2,DHatP3 by replication
  % size(DHatPhi1)=size(DHatPhi2)=size(DHatPhi3)=size(HatPhi)=(n_p, n_int)
  ...
  DET=abs(J11.*(J22.*J33-J32.*J23) - J12.*(J21.*J33-J23.*J31) + J13.*(J21.*J32-J22.*J31));
